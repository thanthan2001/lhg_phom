import 'package:lhg_phom/core/services/model/size_infor_model.dart' show SizeInfoModel;
...
final exampleLendItems = <LendItemModel>[
  ...
  LendItemModel(
    ...
    idNguoiMuon: UserModel(
      ...
      password: '123abc',
      userName: 'Lê Văn C',
      phoneNumbers: '0934567890',
      avatar: null,
      address: 'Đà Nẵng',
      cccd: '1122334455',
      cccdImg: null,
      gender: 'Nam',
      dateOfBirth: DateTime(1988, 9, 12),
      role: 'user',
      isActive: true,
    ),
    donVi: 'Xưởng C',
  ...
  LendItemModel(
    ...
    idNguoiMuon: UserModel(
      ...
      password: '321321',
      userName: 'Lê Thị H',
      phoneNumbers: '0933111222',
      avatar: null,
      address: 'Quảng Nam',
      cccd: '6677889900',
      cccdImg: null,
      gender: 'Nữ',
      dateOfBirth: DateTime(1996, 10, 2),
      role: 'user',
      isActive: true,
    ),
    donVi: 'Xưởng D',
  ...
  LendItemModel(
    ...
    idNguoiMuon: UserModel(
      ...
      password: 'zxcvbn',
      userName: 'Phan Văn I',
      phoneNumbers: '0909090909',
      avatar: null,
      address: 'Gia Lai',
      cccd: '7788990011',
      cccdImg: null,
      gender: 'Nam',
      dateOfBirth: DateTime(1991, 11, 11),
      role: 'user',
      isActive: true,
    ),
    donVi: 'Xưởng A',
